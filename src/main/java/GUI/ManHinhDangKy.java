...
public class ManHinhDangKy extends javax.swing.JFrame {
    ...
    private void buttonDangKyMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_buttonDangKyMouseClicked
        String a = GUI.ManHinhDangKy.textFieldTenNguoiChoi.getText();
        String b = String.valueOf(GUI.ManHinhDangKy.passwordFieldMatKhau.getPassword());
        String c = String.valueOf(GUI.ManHinhDangKy.passwordFieldXacNhanMatKhau.getPassword());
        if(b.equals(c))
        {
            BUS.UserBUS.insert1();
            this.setVisible(false);
            GUI.ManHinhDangNhap frame = new ManHinhDangNhap();
